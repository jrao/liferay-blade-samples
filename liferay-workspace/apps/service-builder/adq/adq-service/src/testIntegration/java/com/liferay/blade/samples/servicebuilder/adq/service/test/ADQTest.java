...
public class ADQTest {
	...
	public void testMassUpdate() throws PortalException {
		...
		List<Bar> bars = BarUtil.findByField1(_BAR1);
		bar1 = bars.get(0);
		Assert.assertTrue(
			"Expected " + 1 + ", but saw " + bar1.getField3(),
			bar1.getField3() == 1);

		bars = BarUtil.findByField1(_BAR2);
		bar2 = bars.get(0);
		Assert.assertTrue(
			"Expected " + 100 + ", but saw " + bar2.getField3(),
			bar2.getField3() == 100);

		bars = BarUtil.findByField1(_BAR3);
		bar3 = bars.get(0);
		Assert.assertTrue(
			"Expected " + 100 + ", but saw " + bar3.getField3(),
			bar3.getField3() == 100);

		bars = BarUtil.findByField1(_BAR4);
		bar4 = bars.get(0);
		Assert.assertTrue(
			"Expected " + 101 + ", but saw " + bar4.getField3(),
			bar4.getField3() == 101);

		bars = BarUtil.findByField1(_BAR5);
		bar5 = bars.get(0);
		Assert.assertTrue(
		...
		bars = BarUtil.findByField1(_BAR1);
		bar1 = bars.get(0);
		Assert.assertTrue(
			"Expected " + 1 + ", but saw " + bar1.getField3(),
			bar1.getField3() == 2);
